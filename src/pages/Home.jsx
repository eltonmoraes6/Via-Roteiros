            ...
            <Col lg="6">
              <div className="hero__content">
                ...
                <p className="justify-text">
                  ...
                  planejado para que você possa aproveitar ao máximo cada
                  momento da viagem.
                  <br />
                  Não perca mais tempo procurando por uma viagem dos sonhos,
                  pois ela está aqui, pronta para ser realizada.
                  <br />
                  <span className="highlight">
                    Entre em contato conosco agora mesmo e garanta sua vaga
